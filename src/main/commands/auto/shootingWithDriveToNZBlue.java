...
public class shootingWithDriveToNZBlue extends CommandGroup implements Constants {
	public shootingWithDriveToNZBlue() {
		...
		addSequential(new TimedTurnToAngleBangBang(15, kToleranceDegreesDefault, 2));
