...
public class TimedTurnToAngle extends TimedCommand implements Constants {
	...
	public TimedTurnToAngle(double heading, double tolerance, double maxV, double KP, double KI, double KD, double time) {
		super(time);
    	requires(Robot.dt);
	...
	@SuppressWarnings("deprecation")
	public TimedTurnToAngle(double heading, double tolerance, double maxV, double time) {
		super(time);
    	requires(Robot.dt);    	
    	this.heading = heading;
    	this.tolerance = tolerance;
    ...
    @SuppressWarnings("deprecation")
	public TimedTurnToAngle(double heading, double tolerance, double time) {
		super(time);
		requires(Robot.dt);
    	this.heading = heading;
    	this.tolerance = tolerance;
    ...
    @SuppressWarnings("deprecation")
	public TimedTurnToAngle(double heading, double time) {
		super(time);
    	requires(Robot.dt);
    	this.heading = heading;
    	this.switchAngle = SmartDashboard.getInt("Turn In Place Controller Switch Angle", 45);
